...
class Tipping_Banner_Wide extends WP_Widget
{
    public function __construct()
    {
        parent::__construct(
            'tipping-banner-wide',
            'LNPW Tipping Banner - Wide'
        );
    }

    public function widget($args, $instance)
    {
        echo do_shortcode("[lnpw_tipping_skyscraper dimension='600x160' title = '{$instance['title']}' description	= '{$instance['description']}'
...
?>
        <div class="tipping_banner">
            ...
            <div class="row">
                ...
                <div class="col-50">
                    <?php if ($background) : ?>
                        <button id="lnpw_tipping_button_image_background" class="widget-tipping-basic-upload_box_image_wide" name="lnpw_tipping_button_image_background"><img width="100" height="100" alt="Tipping box background" src="<?php echo $background[0]; ?>" /></a></button>
                    ...
                    <?php else : ?>
                        <button id="lnpw_tipping_button_image_background" class="widget-tipping-basic-upload_box_image_wide" name="lnpw_tipping_button_image_background"><?php echo esc_html__('Upload', 'text_domain'); ?></button>
            ...
            <div class="row">
                ...
                <div class="col-50">
                    <?php if ($logo_id) : ?>
                        <button id="lnpw_tipping_button_image" class="widget-tipping-basic-upload_box_logo_wide" name="lnpw_tipping_button_image"><img width="100" height="100" alt="Tipping box logo" src="<?php echo $logo[0]; ?>" /></a></button>
                        <button class="widget-tipping-basic-remove_box_image_wide"><?php echo esc_html__('Remove', 'text_domain'); ?></button>
                    ...
                    <?php else : ?>
                        <button id="lnpw_tipping_button_image" class="widget-tipping-basic-upload_box_logo_wide" name="lnpw_tipping_button_image"><?php echo esc_html__('Upload', 'text_domain'); ?></button>
                        <button class="widget-tipping-basic-remove_box_image_wide" style="display:none"><?php echo esc_html__('Remove', 'text_domain'); ?></button>
                        <input type="hidden" class="widget-tipping-basic-logo_id_wide" id="<?php echo esc_attr($this->get_field_id('logo_id')); ?>" name="<?php echo esc_attr($this->get_field_name('logo_id')); ?>" type="text" value="<?php echo esc_attr($logo_id); ?>" />
                    <?php endif; ?>
                </div>
