...
class Tipping_Banner_Wide extends WP_Widget
{
    ...
    {
        echo do_shortcode("[lnpw_tipping_skyscraper dimension='600x200' title = '{$instance['title']}' description	= '{$instance['description']}'
...
<div class="tipping_banner">
    ...
    <div class="row">
        ...
        <div class="col-50">
            <?php if ($background) : ?>
            <button id="lnpw_tipping_button_image_background" class="widget-tipping-basic-upload_box_image_wide"
    ...
    <div class="row">
        ...
        <div class="col-50">
            <?php if ($logo_id) : ?>
            <button id="lnpw_tipping_button_image" class="widget-tipping-basic-upload_box_logo_wide"
