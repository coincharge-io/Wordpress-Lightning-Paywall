...
class Tipping_Banner_High extends WP_Widget
{
    ...
    {
        echo do_shortcode("[lnpw_tipping_skyscraper dimension='200x500' title = '{$instance['title']}' description	= '{$instance['description']}'
    ...
    public function form($instance)
    {
        ...
        $mandatory_name = !empty($instance['mandatory_name']) ? $instance['mandatory_name'] : esc_html__('false', 'text_domain');

        $display_email = !empty($instance['display_email']) ? $instance['display_email'] : esc_html__('true', 'text_domain');
        $mandatory_email = !empty($instance['mandatory_email']) ? $instance['mandatory_email'] : esc_html__('false', 'text_domain');

        $display_address = !empty($instance['display_address']) ? $instance['display_address'] : esc_html__('true', 'text_domain');
        $mandatory_address = !empty($instance['mandatory_address']) ? $instance['mandatory_address'] : esc_html__('false', 'text_domain');

        $display_phone = !empty($instance['display_phone']) ? $instance['display_phone'] : esc_html__('true', 'text_domain');
        $mandatory_phone = !empty($instance['mandatory_phone']) ? $instance['mandatory_phone'] : esc_html__('false', 'text_domain');

        $display_message = !empty($instance['display_message']) ? $instance['display_message'] : esc_html__('true', 'text_domain');
        $mandatory_message = !empty($instance['mandatory_message']) ? $instance['mandatory_message'] : esc_html__('false', 'text_domain');
