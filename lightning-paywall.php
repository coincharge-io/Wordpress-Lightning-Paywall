 ...
 * Description:       With the help of WordPress Lightning Paywall plugin you can offer blog posts (pay-per-post), videos (pay-per-view) and download file (pay-per-file), accepting bitcoin payment via Lightning Network.
 * Version:           1.3.0
 ...
 */
define('LIGHTNING_PAYWALL_VERSION', '1.3.0');
